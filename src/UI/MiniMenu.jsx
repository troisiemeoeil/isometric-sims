...
useEffect(()=> {
 ...
 <div className="menu">
    ...
    <div className="inventory--hotbar">
      ...
      {/* {render} */}
        ...
        <ItemContainer
          ...
          containerdraggable="true"
          id="skyScraperBtn"
          imgUrl="./Model_Images/house_type16.png"
          alt="infinity_blade"
          imgDrag="false"
          tooltipDrag="false"
   ...
   <ItemContainer
          ...
          imgUrl="./Model_Images/house_type21.png"
          alt="iridium_axe"
          imgDrag="false"
          tooltipDrag="false"
          title="Iridium Axe"
      ...
      <ItemContainer
          ...
          containerdraggable="true"
          id="lowBuilding"
          imgUrl="./Model_Images/snow_tile_E.webp"
          alt="iridium_hoe"
          imgDrag="false"
          tooltipDrag="false"
          title="Iridium Hoe"
      ...
      <ItemContainer
          ...
          containerdraggable="true"
          id="smallBuilding"
          imgUrl="./Model_Images/towerRound_crystals.png"
